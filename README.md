...
Things that are put on the internet may truly live forever, but they may not always live where you
expect to find them forever. This section is included to ensure that the original documenation
explaining the design of z-base-32 and the reasoning behind it is preserved as reference material
for this project.

Source: https://philzimmermann.com/docs/human-oriented-base-32-encoding.txt
```
                                                             Zooko O'Whielacronx
                                                                   November 2002
